...
DAYS_NO_CONNECTIVITY_MAX = 3650  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 3650  # send an offroad prompt after 4 days with no internet
...
def thermald_thread():
  ...
  while 1:
    ...
    startup_conditions["hardware_supported"] = True  # health is not None and health.health.hwType != log.HealthData.HwType.whitePanda
